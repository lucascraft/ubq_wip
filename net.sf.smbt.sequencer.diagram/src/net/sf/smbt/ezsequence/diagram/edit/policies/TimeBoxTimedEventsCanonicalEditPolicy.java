 ...
 * @generated
 */
public class TimeBoxTimedEventsCanonicalEditPolicy extends CanonicalEditPolicy {

	/**
	 * @generated
	 */
	protected EStructuralFeature getFeatureToSynchronize() {
		return EzsequencePackage.eINSTANCE.getTimeBox_Events();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<EzsequenceNodeDescriptor> childDescriptors = EzsequenceDiagramUpdater
				.getTimeBoxTimedEvents_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return TimedEventEditPart.VISUAL_ID == EzsequenceVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EzsequenceNodeDescriptor> childDescriptors = EzsequenceDiagramUpdater
				.getTimeBoxTimedEvents_7001SemanticChildren((View) getHost()
						.getModel());
