...
import net.sf.smbt.ezsequence.diagram.part.EzsequenceDiagramEditor;
 ...
 * @generated
 */
public class EzsequenceNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EzsequenceNavigatorItem) {
					selectedElement = ((EzsequenceNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (SequencerEditPart.MODEL_ID
							.equals(EzsequenceVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, EzsequenceDiagramEditor.ID);
