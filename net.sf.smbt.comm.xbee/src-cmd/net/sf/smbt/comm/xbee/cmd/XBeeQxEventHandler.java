...
public class XBeeQxEventHandler extends DefaultTxEventHandlerImpl {
	@Override
	public void handleQxEvent(Event event) {
		CmdPipe engine = event.getQx().getEngine();
		if (engine != null) {
			if (event.getKind().equals(EVENT_KIND.TX_DONE) && event.getCmd() instanceof XBeeSndCmd) {
