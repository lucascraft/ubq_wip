...
* generated by Xtext
*/
package net.sf.smbt.ez.script.ui.contentassist.antlr;
...
public class EzDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected net.sf.smbt.ez.script.ui.contentassist.antlr.internal.InternalEzDslParser createParser() {
		net.sf.smbt.ez.script.ui.contentassist.antlr.internal.InternalEzDslParser result = new net.sf.smbt.ez.script.ui.contentassist.antlr.internal.InternalEzDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMessageOutAccess().getGroup(), "rule__MessageOut__Group__0");
					put(grammarAccess.getMessageInAccess().getGroup(), "rule__MessageIn__Group__0");
					...
					put(grammarAccess.getMessageOutAccess().getOscAssignment_1(), "rule__MessageOut__OscAssignment_1");
					put(grammarAccess.getTriggerAccess().getTriggerAssignment(), "rule__Trigger__TriggerAssignment");
					put(grammarAccess.getMessageInAccess().getOscAssignment_1(), "rule__MessageIn__OscAssignment_1");
					put(grammarAccess.getMessageInAccess().getTriggerAssignment_2(), "rule__MessageIn__TriggerAssignment_2");
					put(grammarAccess.getDataTypeAccess().getNameAssignment_1(), "rule__DataType__NameAssignment_1");
					put(grammarAccess.getDataTypeAccess().getJavaTypeAssignment_3(), "rule__DataType__JavaTypeAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			net.sf.smbt.ez.script.ui.contentassist.antlr.internal.InternalEzDslParser typedParser = (net.sf.smbt.ez.script.ui.contentassist.antlr.internal.InternalEzDslParser) parser;
