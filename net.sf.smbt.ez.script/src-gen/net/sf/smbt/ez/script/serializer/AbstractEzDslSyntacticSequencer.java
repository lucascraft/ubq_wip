...
public class AbstractEzDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (EzDslGrammarAccess) access;
		match_Atomic___LeftParenthesisKeyword_0_2_0_RightParenthesisKeyword_0_2_3__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getAtomicAccess().getLeftParenthesisKeyword_0_2_0()), new TokenAlias(false, false, grammarAccess.getAtomicAccess().getRightParenthesisKeyword_0_2_3()));
