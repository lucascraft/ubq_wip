 ...
 * <ul>
 *   <li>{@link net.sf.smbt.ez.script.ezDsl.impl.SymbolRefImpl#getSymbol <em>Symbol</em>}</li>
 *   <li>{@link net.sf.smbt.ez.script.ezDsl.impl.SymbolRefImpl#getActuals <em>Actuals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SymbolRefImpl extends ExpressionImpl implements SymbolRef
{
  ...
  {
    return EzDslPackage.Literals.SYMBOL_REF;
  }
    ...
    if (symbol != null && symbol.eIsProxy())
    {
      ...
      if (symbol != oldSymbol)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EzDslPackage.SYMBOL_REF__SYMBOL, oldSymbol, symbol));
      }
    }
    return symbol;
  }
  ...
  public void setSymbol(Symbol newSymbol)
  {
    ...
    symbol = newSymbol;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EzDslPackage.SYMBOL_REF__SYMBOL, oldSymbol, symbol));
  }
  ...
  public EList<Expr> getActuals()
  {
    if (actuals == null)
    {
      actuals = new EObjectContainmentEList<Expr>(Expr.class, this, EzDslPackage.SYMBOL_REF__ACTUALS);
    }
    return actuals;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EzDslPackage.SYMBOL_REF__ACTUALS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EzDslPackage.SYMBOL_REF__SYMBOL:
