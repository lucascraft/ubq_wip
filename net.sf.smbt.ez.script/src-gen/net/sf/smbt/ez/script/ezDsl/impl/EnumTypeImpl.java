 ...
 * <ul>
 *   <li>{@link net.sf.smbt.ez.script.ezDsl.impl.EnumTypeImpl#getEnumRef <em>Enum Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumTypeImpl extends PrimitiveTypeImpl implements EnumType
{
  ...
  {
    return EzDslPackage.Literals.ENUM_TYPE;
  }
    ...
    if (enumRef != null && enumRef.eIsProxy())
    {
      ...
      if (enumRef != oldEnumRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EzDslPackage.ENUM_TYPE__ENUM_REF, oldEnumRef, enumRef));
      }
    }
    return enumRef;
  }
  ...
  public void setEnumRef(EnumDecl newEnumRef)
  {
    ...
    enumRef = newEnumRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EzDslPackage.ENUM_TYPE__ENUM_REF, oldEnumRef, enumRef));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EzDslPackage.ENUM_TYPE__ENUM_REF:
