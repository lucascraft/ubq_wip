...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezdaap.EZDaapIntelPropertyElem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EZDaapIntelPropertyElemItemProvider
	 ...
	 * @generated
	 */
	public EZDaapIntelPropertyElemItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns EZDaapIntelPropertyElem.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EZDaapIntelPropertyElem"));
	}
	...
	public String getText(Object object) {
		String label = ((EZDaapIntelPropertyElem)object).getLicense();
		return label == null || label.length() == 0 ?
			getString("_UI_EZDaapIntelPropertyElem_type") :
			getString("_UI_EZDaapIntelPropertyElem_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EZDaapIntelPropertyElem.class)) {
			case EzdaapPackage.EZ_DAAP_INTEL_PROPERTY_ELEM__LICENSE:
