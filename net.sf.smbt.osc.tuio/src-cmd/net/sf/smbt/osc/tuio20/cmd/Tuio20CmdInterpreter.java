...
import net.sf.smbt.osc.tuio.utils.Tuio20CmdUtils;
import net.sf.xqz.model.cmd.Cmd;
import net.sf.xqz.model.engine.impl.AbstractCmdInterpreterImpl;

public class Tuio20CmdInterpreter extends AbstractCmdInterpreterImpl {
	@Override
	public synchronized byte[] cmd2ByteArray(final Cmd cmd) {
		if (cmd instanceof Tuio2DCur || cmd instanceof Tuio2DObj || cmd instanceof TuioBundle) {
			return Tuio20CmdUtils.INSTANCE.dumpTuio20CmdFromEClassifierMsg(cmd);
		}
		return new byte[0];
	}
}
