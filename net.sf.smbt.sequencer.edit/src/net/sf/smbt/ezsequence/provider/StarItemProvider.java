...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezsequence.Star} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StarItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Star_center_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Star_center_feature", "_UI_Star_type"),
				 EzsequencePackage.Literals.STAR__CENTER,
				 true,
				 false,
				 false,
	...
	protected void addRadiusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Star_radius_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Star_radius_feature", "_UI_Star_type"),
				 EzsequencePackage.Literals.STAR__RADIUS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Rectangle labelValue = ((Star)object).getBounds();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Star.class)) {
			case EzsequencePackage.STAR__CENTER:
			case EzsequencePackage.STAR__RADIUS:
