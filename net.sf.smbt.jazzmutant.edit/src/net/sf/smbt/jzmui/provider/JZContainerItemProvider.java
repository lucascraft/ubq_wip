...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.jzmui.JZContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JZContainerItemProvider
	 ...
	 * @generated
	 */
	public JZContainerItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JzmuiPackage.Literals.JZ_CONTAINER__CHILDREN);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JZContainer"));
	}
	...
	public String getText(Object object) {
		String label = ((JZContainer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JZContainer_type") :
			getString("_UI_JZContainer_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JZContainer.class)) {
			case JzmuiPackage.JZ_CONTAINER__FONT_STYLE:
			case JzmuiPackage.JZ_CONTAINER__BOUNDS:
			case JzmuiPackage.JZ_CONTAINER__FONT_NAME:
			case JzmuiPackage.JZ_CONTAINER__NAME:
			case JzmuiPackage.JZ_CONTAINER__PARENT_TARGET:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case JzmuiPackage.JZ_CONTAINER__OSC_PROPS:
			case JzmuiPackage.JZ_CONTAINER__MIDI_PROPS:
			case JzmuiPackage.JZ_CONTAINER__SCRIPTS:
			case JzmuiPackage.JZ_CONTAINER__TARGET_FEATURES:
			case JzmuiPackage.JZ_CONTAINER__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JzmuiPackage.Literals.JZ_CONTAINER__CHILDREN,
