 ...
 * @generated
 */
public class EzosckinematicsAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public EzosckinematicsAdapterFactory() {
	 ...
	 * @generated
	 */
	protected EzosckinematicsSwitch<Adapter> modelSwitch =
		new EzosckinematicsSwitch<Adapter>() {
			@Override
			public Adapter caseKinematicsCmd(KinematicsCmd object) {
				return createKinematicsCmdAdapter();
			}
			@Override
			public Adapter caseKinematicsSndCmd(KinematicsSndCmd object) {
				return createKinematicsSndCmdAdapter();
			}
			@Override
			public Adapter caseKinematicsRcvCmd(KinematicsRcvCmd object) {
				return createKinematicsRcvCmdAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.osc.ezosckinematics.KinematicsCmd <em>Kinematics Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createKinematicsCmdAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.osc.ezosckinematics.KinematicsSndCmd <em>Kinematics Snd Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createKinematicsSndCmdAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.osc.ezosckinematics.KinematicsRcvCmd <em>Kinematics Rcv Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createKinematicsRcvCmdAdapter() {
		return null;
	}
