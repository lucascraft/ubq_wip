 ...
 * @generated
 */
public class EzsequenceDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public EzsequenceDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof EzsequenceDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((EzsequenceDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new EzsequenceDomainNavigatorItem(
