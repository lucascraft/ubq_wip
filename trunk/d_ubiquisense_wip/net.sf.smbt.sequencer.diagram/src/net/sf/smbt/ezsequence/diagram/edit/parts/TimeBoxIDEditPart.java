...
import net.sf.smbt.ezsequence.diagram.edit.policies.EzsequenceTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TimeBoxIDEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				EzsequenceVisualIDRegistry
						.getType(net.sf.smbt.ezsequence.diagram.edit.parts.TimeBoxIDEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public TimeBoxIDEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new EzsequenceTextSelectionEditPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return EzsequenceElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof EzsequenceTextSelectionEditPolicy) {
			((EzsequenceTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof EzsequenceTextSelectionEditPolicy) {
			((EzsequenceTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EzsequenceParserProvider
					.getParser(
							EzsequenceElementTypes.TimeBox_2001,
							getParserElement(),
							EzsequenceVisualIDRegistry
									.getType(net.sf.smbt.ezsequence.diagram.edit.parts.TimeBoxIDEditPart.VISUAL_ID));
		}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					EzsequenceEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
