 ...
 * @generated
 */
public abstract class EzsequenceAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = EzsequenceDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected EzsequenceAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
