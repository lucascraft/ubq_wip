 ...
 * @generated
 */
public class EzsequenceInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EzsequenceNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SequencerEditPart.MODEL_ID));
		EzsequenceDiagramEditorUtil.runWizard(getShell(), wizard,
