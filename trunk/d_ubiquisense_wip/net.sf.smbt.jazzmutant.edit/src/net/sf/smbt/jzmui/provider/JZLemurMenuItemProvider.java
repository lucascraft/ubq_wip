...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.jzmui.JZLemurMenu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JZLemurMenuItemProvider
	 ...
	 * @generated
	 */
	public JZLemurMenuItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addScaleOutputPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Scale Output feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addScaleOutputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZLemurMenu_scaleOutput_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZLemurMenu_scaleOutput_feature", "_UI_JZLemurMenu_type"),
				 JzmuiPackage.Literals.JZ_LEMUR_MENU__SCALE_OUTPUT,
				 true,
				 false,
				 false,
	...
	protected void addTransparentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZLemurMenu_transparent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZLemurMenu_transparent_feature", "_UI_JZLemurMenu_type"),
				 JzmuiPackage.Literals.JZ_LEMUR_MENU__TRANSPARENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addFontPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZLemurMenu_font_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZLemurMenu_font_feature", "_UI_JZLemurMenu_type"),
				 JzmuiPackage.Literals.JZ_LEMUR_MENU__FONT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZLemurMenu_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZLemurMenu_color_feature", "_UI_JZLemurMenu_type"),
				 JzmuiPackage.Literals.JZ_LEMUR_MENU__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSelectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZLemurMenu_selection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZLemurMenu_selection_feature", "_UI_JZLemurMenu_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JzmuiPackage.Literals.JZ_LEMUR_MENU__ITEMS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JZLemurMenu"));
	}
	...
	public String getText(Object object) {
		String label = ((JZLemurMenu)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JZLemurMenu_type") :
			getString("_UI_JZLemurMenu_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JZLemurMenu.class)) {
			case JzmuiPackage.JZ_LEMUR_MENU__FONT_STYLE:
			case JzmuiPackage.JZ_LEMUR_MENU__BOUNDS:
			case JzmuiPackage.JZ_LEMUR_MENU__FONT_NAME:
			case JzmuiPackage.JZ_LEMUR_MENU__NAME:
			case JzmuiPackage.JZ_LEMUR_MENU__PARENT_TARGET:
			case JzmuiPackage.JZ_LEMUR_MENU__PRIMARY_OSC_TARGET:
			case JzmuiPackage.JZ_LEMUR_MENU__PRIMARY_MIDI_TARGET:
			case JzmuiPackage.JZ_LEMUR_MENU__SCALE_OUTPUT:
			case JzmuiPackage.JZ_LEMUR_MENU__TRANSPARENT:
			case JzmuiPackage.JZ_LEMUR_MENU__FONT:
			case JzmuiPackage.JZ_LEMUR_MENU__COLOR:
			case JzmuiPackage.JZ_LEMUR_MENU__SELECTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case JzmuiPackage.JZ_LEMUR_MENU__OSC_PROPS:
			case JzmuiPackage.JZ_LEMUR_MENU__MIDI_PROPS:
			case JzmuiPackage.JZ_LEMUR_MENU__SCRIPTS:
			case JzmuiPackage.JZ_LEMUR_MENU__TARGET_FEATURES:
			case JzmuiPackage.JZ_LEMUR_MENU__ITEMS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JzmuiPackage.Literals.JZ_LEMUR_MENU__ITEMS,
				 JzmuiFactory.eINSTANCE.createJZMenuItem()));
	}
