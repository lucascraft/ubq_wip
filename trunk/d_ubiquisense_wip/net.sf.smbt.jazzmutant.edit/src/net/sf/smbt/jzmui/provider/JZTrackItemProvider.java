...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.jzmui.JZTrack} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JZTrackItemProvider
	 ...
	 * @generated
	 */
	public JZTrackItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addModeXYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZTrack_modeXY_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZTrack_modeXY_feature", "_UI_JZTrack_type"),
				 JzmuiPackage.Literals.JZ_TRACK__MODE_XY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTransparentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZTrack_transparent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZTrack_transparent_feature", "_UI_JZTrack_type"),
				 JzmuiPackage.Literals.JZ_TRACK__TRANSPARENT,
				 true,
				 false,
				 false,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JZTrack_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JZTrack_color_feature", "_UI_JZTrack_type"),
				 JzmuiPackage.Literals.JZ_TRACK__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JZTrack"));
	}
	...
	public String getText(Object object) {
		String label = ((JZTrack)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_JZTrack_type") :
			getString("_UI_JZTrack_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JZTrack.class)) {
			case JzmuiPackage.JZ_TRACK__FONT_STYLE:
			case JzmuiPackage.JZ_TRACK__BOUNDS:
			case JzmuiPackage.JZ_TRACK__FONT_NAME:
			case JzmuiPackage.JZ_TRACK__NAME:
			case JzmuiPackage.JZ_TRACK__PARENT_TARGET:
			case JzmuiPackage.JZ_TRACK__PRIMARY_OSC_TARGET:
			case JzmuiPackage.JZ_TRACK__PRIMARY_MIDI_TARGET:
			case JzmuiPackage.JZ_TRACK__MODE_XY:
			case JzmuiPackage.JZ_TRACK__TRANSPARENT:
			case JzmuiPackage.JZ_TRACK__COLOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case JzmuiPackage.JZ_TRACK__OSC_PROPS:
			case JzmuiPackage.JZ_TRACK__MIDI_PROPS:
			case JzmuiPackage.JZ_TRACK__SCRIPTS:
			case JzmuiPackage.JZ_TRACK__TARGET_FEATURES:
