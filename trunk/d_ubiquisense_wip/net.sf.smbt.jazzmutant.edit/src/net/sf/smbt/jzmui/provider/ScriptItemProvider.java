...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.jzmui.Script} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Script_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Script_expr_feature", "_UI_Script_type"),
				 JzmuiPackage.Literals.SCRIPT__EXPR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Script)object).getExpr();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Script.class)) {
			case JzmuiPackage.SCRIPT__EXPR:
