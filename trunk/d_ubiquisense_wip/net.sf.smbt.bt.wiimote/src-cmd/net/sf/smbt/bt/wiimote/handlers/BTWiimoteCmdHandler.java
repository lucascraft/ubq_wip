...
public class BTWiimoteCmdHandler extends AbstractCmdInterpreterImpl {
	@Override
	public synchronized byte[] cmd2ByteArray(final Cmd cmd) {
		return cmd instanceof WiiCmd ? BTWiimoteCmdUtils.INSTANCE.dumpWimmoteCmd((WiiCmd)cmd) : new byte[0];
	}
}
