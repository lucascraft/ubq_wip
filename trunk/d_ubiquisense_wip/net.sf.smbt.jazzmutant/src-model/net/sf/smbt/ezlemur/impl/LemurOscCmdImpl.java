...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lemur Osc Cmd</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.ezlemur.impl.LemurOscCmdImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LemurOscCmdImpl extends OscCmdImpl implements LemurOscCmd {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected LemurOscCmdImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EzlemurPackage.Literals.LEMUR_OSC_CMD;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractLemurOscCmd.class) {
			switch (derivedFeatureID) {
				case EzlemurPackage.LEMUR_OSC_CMD__TARGET: return EzlemurPackage.ABSTRACT_LEMUR_OSC_CMD__TARGET;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractLemurOscCmd.class) {
			switch (baseFeatureID) {
				case EzlemurPackage.ABSTRACT_LEMUR_OSC_CMD__TARGET: return EzlemurPackage.LEMUR_OSC_CMD__TARGET;
				default: return -1;
			}
		}
