...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tabpage</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.touchosc.touchosc.impl.TabpageImpl#getControl <em>Control</em>}</li>
 *   <li>{@link net.sf.smbt.touchosc.touchosc.impl.TabpageImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TabpageImpl extends EObjectImpl implements Tabpage {
	...
	protected EClass eStaticClass() {
		return TouchoscPackage.Literals.TABPAGE;
	}
	...
	public EList<Control> getControl() {
		if (control == null) {
			control = new EObjectContainmentEList<Control>(Control.class, this, TouchoscPackage.TABPAGE__CONTROL);
		}
		return control;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TouchoscPackage.TABPAGE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TouchoscPackage.TABPAGE__CONTROL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TouchoscPackage.TABPAGE__CONTROL:
				return getControl();
			case TouchoscPackage.TABPAGE__NAME:
				return getName();
		}
