...
public class AbletonFeedbackLinkQxEventHandler extends
		AbstractQxEventHandlerImpl {
	...
	class KnobUpdater extends UbiJob {
		AbletonFeedbackLinkQxEventHandler handler;
		private float value;
		...
		public KnobUpdater(AbletonFeedbackLinkQxEventHandler handler) {
			super("KnobUpdater");
			setSystem(true);
	...
	public AbletonFeedbackLinkQxEventHandler(UbiKnob knob, String oscTag, int argIndex, float factor) {
		this.knob = knob;
		this.oscTag = oscTag;
		this.idx = argIndex;
