...
public class LinkFeedbackAbletonQxEventHandler extends AbstractQxEventHandlerImpl {
	...
	class KnobUpdater extends UbiJob {
		LinkFeedbackAbletonQxEventHandler handler;
		private float value;
		...
		public KnobUpdater(LinkFeedbackAbletonQxEventHandler handler) {
			super("KnobUpdater");
			setSystem(true);
	...
	public LinkFeedbackAbletonQxEventHandler(UbiKnob knob, String oscTag, int argIndex, float factor) {
		this.knob = knob;
		this.oscTag = oscTag;
		this.idx = argIndex;
