...
package net.sf.smbt.ui.blinkm.actions;

import net.sf.smbt.ui.blinkm.BlinkMCtrlView;
import net.sf.smbt.ui.blinkm.RGBStepControlUI;
	...
	public void run(final IAction action) {
		...
		Display.getDefault().asyncExec(new Runnable() {
			public void run() {
				...
				try {
					BlinkMCtrlView wiimoteView = (BlinkMCtrlView) page.showView(BlinkMCtrlView.ID);
