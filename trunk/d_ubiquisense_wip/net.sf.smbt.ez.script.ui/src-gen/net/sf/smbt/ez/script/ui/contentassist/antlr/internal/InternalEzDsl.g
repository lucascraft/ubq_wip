...
// Entry rule entryRuleMessageOut
entryRuleMessageOut 
:
{ before(grammarAccess.getMessageOutRule()); }
	 ruleMessageOut
{ after(grammarAccess.getMessageOutRule()); } 
	 EOF 
;
...
ruleMessageOut
	...
	:
(
{ before(grammarAccess.getMessageOutAccess().getGroup()); }
(rule__MessageOut__Group__0)
{ after(grammarAccess.getMessageOutAccess().getGroup()); }
)
...
{ after(grammarAccess.getElementAccess().getReturnParserRuleCall_3()); }
    ...
    |(
{ before(grammarAccess.getElementAccess().getAssertParserRuleCall_4()); }
	ruleAssert
{ after(grammarAccess.getElementAccess().getAssertParserRuleCall_4()); }
)
...
:
	rule__MessageOut__Group__0__Impl
	rule__MessageOut__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMessageOutAccess().getMsgKeyword_0()); }

	'msg' 

{ after(grammarAccess.getMessageOutAccess().getMsgKeyword_0()); }
)
...
:
	rule__MessageOut__Group__1__Impl
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
{ before(grammarAccess.getMessageOutAccess().getOscAssignment_1()); }
(rule__MessageOut__OscAssignment_1)
{ after(grammarAccess.getMessageOutAccess().getOscAssignment_1()); }
)
...
:
(
{ before(grammarAccess.getMessageOutAccess().getOscOSCExprCrossReference_1_0()); }
(
{ before(grammarAccess.getMessageOutAccess().getOscOSCExprIDTerminalRuleCall_1_0_1()); }
	RULE_ID{ after(grammarAccess.getMessageOutAccess().getOscOSCExprIDTerminalRuleCall_1_0_1()); }
)
{ after(grammarAccess.getMessageOutAccess().getOscOSCExprCrossReference_1_0()); }
)
...
:
(
{ before(grammarAccess.getAtomicAccess().getValueFloatTypeParserRuleCall_1_1_0()); }
	ruleFloatType{ after(grammarAccess.getAtomicAccess().getValueFloatTypeParserRuleCall_1_1_0()); }
)
