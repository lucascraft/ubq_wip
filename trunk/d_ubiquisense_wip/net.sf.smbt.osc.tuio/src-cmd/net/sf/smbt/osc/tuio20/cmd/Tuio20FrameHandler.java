...
public class Tuio20FrameHandler extends AbstractFrameInterpreterImpl {
	private OSCByteArrayToJavaConverter converter;
	public Tuio20FrameHandler() {
	...
	public synchronized Cmd byteArray2Cmd(final byte[] stream) {
		if (stream != null && stream.length>1) {
			...
			if (packet instanceof OSCMessage) {
				//return acceptMessage(new Date(System.currentTimeMillis()), (OSCMessage) packet);
			}
		}
		return null;
	}
