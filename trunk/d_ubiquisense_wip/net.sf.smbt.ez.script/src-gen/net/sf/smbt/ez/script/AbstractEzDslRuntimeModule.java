...
/**
 * Manual modifications go to {net.sf.smbt.ez.script.EzDslRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractEzDslRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "net/sf/smbt/ez/script/EzDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("net.sf.smbt.ez.script.EzDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("ez");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return net.sf.smbt.ez.script.services.EzDslGrammarAccess.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return net.sf.smbt.ez.script.parser.antlr.EzDslParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return net.sf.smbt.ez.script.parser.antlr.EzDslAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return net.sf.smbt.ez.script.parser.antlr.internal.InternalEzDslLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<net.sf.smbt.ez.script.parser.antlr.internal.InternalEzDslLexer> provideInternalEzDslLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(net.sf.smbt.ez.script.parser.antlr.internal.InternalEzDslLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(net.sf.smbt.ez.script.parser.antlr.internal.InternalEzDslLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends net.sf.smbt.ez.script.validation.EzDslJavaValidator> bindEzDslJavaValidator() {
		return net.sf.smbt.ez.script.validation.EzDslJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return null; // net.sf.smbt.ez.script.jvmmodel.EzDslJvmModelInferrer.class;
	}

	// contributed by org.eclipse.xtext.generator.formatting.FormatterFragment
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return net.sf.smbt.ez.script.formatting.EzDslFormatter.class;
	}
