...
@parser::members {
    ...
    public InternalEzDslParser(TokenStream input, EzDslGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected EzDslGrammarAccess getGrammarAccess() {
...
entryRuleMessageOut returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMessageOutRule()); }
	 iv_ruleMessageOut=ruleMessageOut 
	 { $current=$iv_ruleMessageOut.current; } 
	 EOF 
;

// Rule MessageOut
ruleMessageOut returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='msg' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMessageOutAccess().getMsgKeyword_0());
    }
(
(
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getMessageOutRule());
	        }
        }
	otherlv_1=RULE_ID
	{
		newLeafNode(otherlv_1, grammarAccess.getMessageOutAccess().getOscOSCExprCrossReference_1_0()); 
	}
...
(
    ...
    |
    { 
        newCompositeNode(grammarAccess.getElementAccess().getAssertParserRuleCall_4()); 
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getAtomicAccess().getValueFloatTypeParserRuleCall_1_1_0()); 
	    }
		lv_value_8_0=ruleFloatType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getAtomicRule());
	        }
       		set(
