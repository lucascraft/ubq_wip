 ...
 * <ul>
 *   <li>{@link net.sf.smbt.ez.script.ezDsl.SymbolRef#getSymbol <em>Symbol</em>}</li>
 *   <li>{@link net.sf.smbt.ez.script.ezDsl.SymbolRef#getActuals <em>Actuals</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.smbt.ez.script.ezDsl.EzDslPackage#getSymbolRef()
 * @model
 * @generated
 */
public interface SymbolRef extends Expression
{
   ...
   * @see net.sf.smbt.ez.script.ezDsl.EzDslPackage#getSymbolRef_Symbol()
   * @model
   * @generated
   */
  Symbol getSymbol();
  ...
  /**
   * Sets the value of the '{@link net.sf.smbt.ez.script.ezDsl.SymbolRef#getSymbol <em>Symbol</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link net.sf.smbt.ez.script.ezDsl.Expr}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see net.sf.smbt.ez.script.ezDsl.EzDslPackage#getSymbolRef_Actuals()
