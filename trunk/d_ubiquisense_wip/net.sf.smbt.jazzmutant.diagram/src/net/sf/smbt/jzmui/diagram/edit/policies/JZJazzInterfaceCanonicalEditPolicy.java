 ...
 * @generated
 */
public class JZJazzInterfaceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<JzmuiNodeDescriptor> childDescriptors = JzmuiDiagramUpdater
				.getJZJazzInterface_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return JZJazzInterface2EditPart.VISUAL_ID == JzmuiVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<JzmuiNodeDescriptor> childDescriptors = JzmuiDiagramUpdater
				.getJZJazzInterface_1000SemanticChildren((View) getHost()
						.getModel());
