 ...
 * @generated
 */
public abstract class JzmuiAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = JzmuiDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected JzmuiAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
