...
public class JZUICustomButtonFontSizeOffSection extends AbstractEnumerationPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_CUSTOM_BUTTON__FONT_SIZE;
	}
	...
	protected Object getOldFeatureValue() {
		return getEObject() instanceof JZCustomButton ? 
				((JZCustomButton)getEObject()).getFontSize()
					: "";
	}
