...
public class JZUICustomButtonStyleOnSection extends AbstractEnumerationPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_CUSTOM_BUTTON__STYLE_ON;
	}
	...
	protected Object getOldFeatureValue() {
		return getEObject() instanceof JZCustomButton ? 
				((JZCustomButton)getEObject()).getStyleOn()
					: "";
	}
