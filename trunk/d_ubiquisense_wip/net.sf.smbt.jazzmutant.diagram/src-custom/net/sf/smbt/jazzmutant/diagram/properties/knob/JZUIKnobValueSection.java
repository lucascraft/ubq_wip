...
public class JZUIKnobValueSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_KNOB__VALUE;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZKnob)getEObject()).getValue());
	}
}
