...
public class JZUIMultiBallsReleaseSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__RELEASE;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZMultiBalls)getEObject()).getRelease());
	}
}
