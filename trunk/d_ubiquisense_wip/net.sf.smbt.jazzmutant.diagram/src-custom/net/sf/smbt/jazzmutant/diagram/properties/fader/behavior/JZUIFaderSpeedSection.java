...
public class JZUIFaderSpeedSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_FADER__SPEED;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZFader)getEObject()).getSpeed());
	}
}
