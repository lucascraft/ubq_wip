...
public class JZUIKnobFrictionSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_KNOB__FRICTION;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZKnob)getEObject()).getFriction());
	}
}
