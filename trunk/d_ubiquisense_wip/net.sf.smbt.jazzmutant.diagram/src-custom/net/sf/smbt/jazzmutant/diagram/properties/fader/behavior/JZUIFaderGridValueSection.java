...
public class JZUIFaderGridValueSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_FADER__GRID_VALUE;
	}
	...
	protected Integer getFeatureInteger() {
		return new Integer(((JZFader)getEObject()).getGridValue());
	}
}
