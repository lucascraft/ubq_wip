...
public class JZUIMultiBallsAttackSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__ATTACK;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZMultiBalls)getEObject()).getAttack());
	}
}
