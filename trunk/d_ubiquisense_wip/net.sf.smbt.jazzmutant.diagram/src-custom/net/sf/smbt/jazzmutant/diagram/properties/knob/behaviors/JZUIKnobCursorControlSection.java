...
public class JZUIKnobCursorControlSection extends AbstractEnumerationPropertySection {
	...
	private static String[] choices =  new String[] { 
		KNOB_CONTROL.NONE.getLiteral(), 
		KNOB_CONTROL.LINEAR.getLiteral(), 
		KNOB_CONTROL.POLAR.getLiteral()
	};
	...
	protected Object getFeatureValue(int index) {
		return getCombo().getSelectionIndex() >= 0 ? KNOB_CONTROL.VALUES.get(getCombo().getSelectionIndex()) : KNOB_CONTROL.NONE;
	}
