...
public class JZUIMultiBallsGridYSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__GRID_STEP_Y;
	}
	...
	protected Integer getFeatureInteger() {
		return new Integer(((JZMultiBalls)getEObject()).getGridStepY());
	}
}
