...
public class JZUIMultiBallsGridXSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__GRID_STEP_X;
	}
	...
	protected Integer getFeatureInteger() {
		return new Integer(((JZMultiBalls)getEObject()).getGridStepX());
	}
}
