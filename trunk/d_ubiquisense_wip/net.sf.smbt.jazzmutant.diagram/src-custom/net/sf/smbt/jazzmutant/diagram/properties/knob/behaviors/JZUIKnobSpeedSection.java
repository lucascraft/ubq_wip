...
public class JZUIKnobSpeedSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_KNOB__SPEED;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZKnob)getEObject()).getSpeed());
	}
}
