...
public class DXMCuesDetailsContentProvider implements ITreeContentProvider {
	private boolean topNodesOnly;
	private FixtureDefinition fixture;
	
	public DXMCuesDetailsContentProvider() {
		this(false);
	}
	
	public DXMCuesDetailsContentProvider(boolean topNodesOnly) {
