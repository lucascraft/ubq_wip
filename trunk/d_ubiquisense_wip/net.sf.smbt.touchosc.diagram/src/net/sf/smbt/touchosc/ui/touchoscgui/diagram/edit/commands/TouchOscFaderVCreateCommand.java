 ...
 * @generated
 */
public class TouchOscFaderVCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscFaderVCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscFaderV newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscFaderV();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getFadersV().add(newElement);

		ElementInitializers.getInstance().init_TouchOscFaderV_3002(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscFaderV newElement,
