 ...
 * @generated
 */
public class TouchOscEncoderCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscEncoderCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscEncoder newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscEncoder();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getEncoders().add(newElement);

		ElementInitializers.getInstance().init_TouchOscEncoder_3014(newElement);
		newElement.setName("encoder" + TouchOscGuiUtilities.INSTANCE.getCounter("encoder"));
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscEncoder newElement,
