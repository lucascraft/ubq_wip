 ...
 * @generated
 */
public class TouchOscFaderHCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscFaderHCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscFaderH newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscFaderH();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getFadersH().add(newElement);

		ElementInitializers.getInstance().init_TouchOscFaderH_3001(newElement);
		newElement.setName("fader" + TouchOscGuiUtilities.INSTANCE.getCounter("fader"));
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscFaderH newElement,
