 ...
 * @generated
 */
public class TouchOscTabPageItemSemanticEditPolicy extends
		TouchoscguiBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TouchOscTabPageItemSemanticEditPolicy() {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (TouchoscguiVisualIDRegistry.getVisualID(node)) {
			case TouchOscTabPageTouchOscTabPageCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (TouchoscguiVisualIDRegistry.getVisualID(cnode)) {
