 ...
 * @generated
 */
public class TouchoscguiNavigatorContentProvider implements
	...
	public TouchoscguiNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<TouchoscguiNavigatorItem> result = new ArrayList<TouchoscguiNavigatorItem>();
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, TouchOscLayoutEditPart.MODEL_ID),
					file, false));
			return result.toArray();
		}

		if (parentElement instanceof TouchoscguiNavigatorGroup) {
			TouchoscguiNavigatorGroup group = (TouchoscguiNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof TouchoscguiNavigatorItem) {
			TouchoscguiNavigatorItem navigatorItem = (TouchoscguiNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TouchOscLayoutEditPart.VISUAL_ID: {
			LinkedList<TouchoscguiAbstractNavigatorItem> result = new LinkedList<TouchoscguiAbstractNavigatorItem>();
			Diagram sv = (Diagram) view;
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					TouchoscguiVisualIDRegistry
							.getType(TouchOscTabPageEditPart.VISUAL_ID));
		...
		case TouchOscTabPageEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(
					...
					TouchoscguiVisualIDRegistry
							.getType(TouchOscTabPageTouchOscTabPageCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscFaderHEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscFaderVEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscLabelHEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscLabelVEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscLEDEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscMultiToggleEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscPushEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscRotaryHEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscRotaryVEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscXYPadEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscToggleEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscTimeHEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscTimeVEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscEncoderEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscBatteryHEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscBatteryVEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscMultiFaderHEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscMultiFaderVEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					TouchoscguiVisualIDRegistry
							.getType(TouchOscMultiPushEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
	 ...
	 * @generated
	 */
	private Collection<TouchoscguiNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<TouchoscguiNavigatorItem> result = new ArrayList<TouchoscguiNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new TouchoscguiNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof TouchoscguiAbstractNavigatorItem) {
			TouchoscguiAbstractNavigatorItem abstractNavigatorItem = (TouchoscguiAbstractNavigatorItem) element;
