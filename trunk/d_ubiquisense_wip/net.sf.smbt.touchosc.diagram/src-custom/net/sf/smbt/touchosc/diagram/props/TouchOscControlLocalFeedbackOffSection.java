...
public class TouchOscControlLocalFeedbackOffSection extends AbstractBooleanPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return TouchoscguiPackage.Literals.TOUCH_OSC_CONTROL__LOCAL_FEEDBACK_OFF;
	}

	@Override
	protected String getLabelText() {
		return "Local Feedback off";
	}
