...
public class TouchOscControlFromSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return TouchoscguiPackage.Literals.TOUCH_OSC_CONTROL__SCALEF;
	}
	...
	protected Integer getFeatureInteger() {
		return getEObject() instanceof TouchOscControl ? 
				new Integer(((TouchOscControl)getEObject()).getScalef())
					: new Integer(0);
	}
