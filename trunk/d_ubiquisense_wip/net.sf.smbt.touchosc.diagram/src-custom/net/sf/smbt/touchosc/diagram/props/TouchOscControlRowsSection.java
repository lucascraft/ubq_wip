...
public class TouchOscControlRowsSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return TouchoscguiPackage.Literals.TOUCH_OSC_CONTROL__NUMBER_Y;
	}
	...
	protected Integer getFeatureInteger() {
		return getEObject() instanceof TouchOscControl ? 
				new Integer(((TouchOscControl)getEObject()).getNumber_y())
					: new Integer(0);
	}
