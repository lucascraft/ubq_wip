 ...
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.EnumTypeImpl#getEnumRef <em>Enum Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumTypeImpl extends PrimitiveTypeImpl implements EnumType
{
  ...
  {
    return OscDslPackage.Literals.ENUM_TYPE;
  }
    ...
    if (enumRef != null && enumRef.eIsProxy())
    {
      ...
      if (enumRef != oldEnumRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, OscDslPackage.ENUM_TYPE__ENUM_REF, oldEnumRef, enumRef));
      }
    }
    return enumRef;
  }
  ...
  public void setEnumRef(EnumDecl newEnumRef)
  {
    ...
    enumRef = newEnumRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.ENUM_TYPE__ENUM_REF, oldEnumRef, enumRef));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OscDslPackage.ENUM_TYPE__ENUM_REF:
