...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OSC Bluetooth Target</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCBluetoothTargetImpl#getProto <em>Proto</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCBluetoothTargetImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCBluetoothTargetImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OSCBluetoothTargetImpl extends MinimalEObjectImpl.Container implements OSCBluetoothTarget
{
  /**
   ...
   * @generated
   */
  protected OSCBluetoothTargetImpl()
  {
    super();
  }
  ...
  {
    return OscDslPackage.Literals.OSC_BLUETOOTH_TARGET;
  }
  ...
  public void setProto(String newProto)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSC_BLUETOOTH_TARGET__PROTO, oldProto, proto));
  }
  ...
  public void setAddr(String newAddr)
  {
    ...
    addr = newAddr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSC_BLUETOOTH_TARGET__ADDR, oldAddr, addr));
  }
  ...
  public void setFormat(EzFormats newFormat)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSC_BLUETOOTH_TARGET__FORMAT, oldFormat, format));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OscDslPackage.OSC_BLUETOOTH_TARGET__PROTO:
        return getProto();
      case OscDslPackage.OSC_BLUETOOTH_TARGET__ADDR:
        return getAddr();
      case OscDslPackage.OSC_BLUETOOTH_TARGET__FORMAT:
        return getFormat();
    }
