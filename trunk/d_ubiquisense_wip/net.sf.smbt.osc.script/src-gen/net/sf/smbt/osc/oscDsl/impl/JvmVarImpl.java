 ...
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.JvmVarImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.JvmVarImpl#getJavaTypes <em>Java Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JvmVarImpl extends MinimalEObjectImpl.Container implements JvmVar
{
  ...
  {
    return OscDslPackage.Literals.JVM_VAR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.JVM_VAR__NAME, oldName, name));
  }
  ...
  public EList<JvmType> getJavaTypes()
  {
    if (javaTypes == null)
    {
      javaTypes = new EObjectResolvingEList<JvmType>(JvmType.class, this, OscDslPackage.JVM_VAR__JAVA_TYPES);
    }
    return javaTypes;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OscDslPackage.JVM_VAR__NAME:
        return getName();
      case OscDslPackage.JVM_VAR__JAVA_TYPES:
        return getJavaTypes();
    }
