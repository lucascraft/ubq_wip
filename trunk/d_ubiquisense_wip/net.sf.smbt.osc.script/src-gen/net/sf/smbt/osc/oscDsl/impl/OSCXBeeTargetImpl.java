...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OSCX Bee Target</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCXBeeTargetImpl#getProto <em>Proto</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCXBeeTargetImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCXBeeTargetImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OSCXBeeTargetImpl extends MinimalEObjectImpl.Container implements OSCXBeeTarget
{
  /**
  ...
  {
    return OscDslPackage.Literals.OSCX_BEE_TARGET;
  }
  ...
  public void setProto(String newProto)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCX_BEE_TARGET__PROTO, oldProto, proto));
  }
  ...
  public void setAddr(String newAddr)
  {
    ...
    addr = newAddr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCX_BEE_TARGET__ADDR, oldAddr, addr));
  }
  ...
  public void setFormat(EzFormats newFormat)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCX_BEE_TARGET__FORMAT, oldFormat, format));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OscDslPackage.OSCX_BEE_TARGET__PROTO:
        return getProto();
      case OscDslPackage.OSCX_BEE_TARGET__ADDR:
        return getAddr();
      case OscDslPackage.OSCX_BEE_TARGET__FORMAT:
        return getFormat();
    }
