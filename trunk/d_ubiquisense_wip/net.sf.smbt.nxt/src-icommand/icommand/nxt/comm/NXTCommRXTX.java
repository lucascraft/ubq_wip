...
/**
 * NXTCommRXTX is the base class for communicating with the NXT via Bluetooth.
 * Usage: All methods in NXTCommRXTX are static. 
 * NXTCommRXTX.connect();
...
class NXTCommRXTX implements NXTComm
{
	...
	public NXTCommRXTX(Properties props) {
		this.props = props;
	}
