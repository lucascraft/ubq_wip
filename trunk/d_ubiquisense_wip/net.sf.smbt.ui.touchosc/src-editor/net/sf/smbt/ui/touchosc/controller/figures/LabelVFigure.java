...
import net.sf.smbt.ui.touchosc.controller.utils.LemurUIUtils;
...
public class LabelVFigure extends AbstractLemurFigure {
	private LabelV text;
	private Font font;
	public LabelVFigure(LabelV elem) {
		super(elem);
		text = elem;
		font = new Font(
			Display.getDefault(), 
			new FontData(
				"Tahoma", //elem.getFontName(), 
				10, //elem.getFontSize(), 
				SWT.NORMAL//elem.getFontStyle()
			)
		);
	}
	@Override
