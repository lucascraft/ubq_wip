...
public abstract class AbstractMpptOutlinePage extends Page implements IContentOutlinePage, ISelectionChangedListener, IAdaptable {
	...
	private AbstractMpptModelNavigator navigator;
...
//	private CollapseAllHandler collapseAllHandler;
	 ...
	 */
	public AbstractMpptOutlinePage(MpptEditor ed) {
...
//	}
	 ...
	 */
	protected abstract AbstractMpptModelNavigator createNavigator(Composite parent, IPageSite pageSite);
