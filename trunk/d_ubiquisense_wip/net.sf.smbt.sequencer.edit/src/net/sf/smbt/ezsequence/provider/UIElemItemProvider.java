...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezsequence.UIElem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIElemItemProvider
	 ...
	 * @generated
	 */
	public UIElemItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UIElem"));
	}
	...
	public String getText(Object object) {
		Rectangle labelValue = ((UIElem)object).getBounds();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_UIElem_type") :
			getString("_UI_UIElem_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UIElem.class)) {
			case EzsequencePackage.UI_ELEM__BOUNDS:
			case EzsequencePackage.UI_ELEM__FG:
			case EzsequencePackage.UI_ELEM__BG:
			case EzsequencePackage.UI_ELEM__VISIBLE:
			case EzsequencePackage.UI_ELEM__SELECTED:
			case EzsequencePackage.UI_ELEM__DISABLED:
