...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezsequence.AbstractPort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractPortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractPort_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractPort_label_feature", "_UI_AbstractPort_type"),
				 EzsequencePackage.Literals.ABSTRACT_PORT__LABEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AbstractPort)object).getLabel();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractPort.class)) {
			case EzsequencePackage.ABSTRACT_PORT__LABEL:
