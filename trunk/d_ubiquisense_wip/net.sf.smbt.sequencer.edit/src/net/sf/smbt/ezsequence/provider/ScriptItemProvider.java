...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezsequence.Script} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Script_body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Script_body_feature", "_UI_Script_type"),
				 EzsequencePackage.Literals.SCRIPT__BODY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Script)object).getBody();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Script.class)) {
			case EzsequencePackage.SCRIPT__BODY:
