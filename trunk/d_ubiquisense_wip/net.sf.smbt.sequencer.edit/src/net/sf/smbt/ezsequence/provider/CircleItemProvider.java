...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ezsequence.Circle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CircleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Circle_center_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Circle_center_feature", "_UI_Circle_type"),
				 EzsequencePackage.Literals.CIRCLE__CENTER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EzsequencePackage.Literals.CIRCLE__RADIUS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Rectangle labelValue = ((Circle)object).getBounds();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Circle.class)) {
			case EzsequencePackage.CIRCLE__CENTER:
			case EzsequencePackage.CIRCLE__RADIUS:
