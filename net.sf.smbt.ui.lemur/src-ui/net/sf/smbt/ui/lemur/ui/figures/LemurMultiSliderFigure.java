...
public class LemurMultiSliderFigure extends AbstractLemurFigure {
	private JZmultiSlider multiSlider;
	public LemurMultiSliderFigure(JZmultiSlider elem) {
    	super(elem);
    	multiSlider = elem;
