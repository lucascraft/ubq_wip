...
{ 
    ...
    */
   public TachoNavigator(double wheelDiameter, double trackWidth, Motor leftMotor, Motor rightMotor, boolean reverse) 
   {
    ...
    */
   public double getAngle() { return _heading;} 
   ...
   public void updatePosition()
   {
      ...
      double turnAngle = direction*(outside-inside)*_pilot._wheelDiameter/(2*_pilot._trackWidth);
