...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OSCTCP Target</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCTCPTargetImpl#getProto <em>Proto</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCTCPTargetImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCTCPTargetImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OSCTCPTargetImpl extends MinimalEObjectImpl.Container implements OSCTCPTarget
{
  /**
  ...
  {
    return OscDslPackage.Literals.OSCTCP_TARGET;
  }
  ...
  public void setProto(String newProto)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCTCP_TARGET__PROTO, oldProto, proto));
  }
  ...
  public void setAddr(String newAddr)
  {
    ...
    addr = newAddr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCTCP_TARGET__ADDR, oldAddr, addr));
  }
  ...
  public void setFormat(EzFormats newFormat)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCTCP_TARGET__FORMAT, oldFormat, format));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OscDslPackage.OSCTCP_TARGET__PROTO:
        return getProto();
      case OscDslPackage.OSCTCP_TARGET__ADDR:
        return getAddr();
      case OscDslPackage.OSCTCP_TARGET__FORMAT:
        return getFormat();
    }
