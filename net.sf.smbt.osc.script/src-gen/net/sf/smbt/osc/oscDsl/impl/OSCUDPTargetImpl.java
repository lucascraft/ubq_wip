...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OSCUDP Target</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCUDPTargetImpl#getProto <em>Proto</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCUDPTargetImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.impl.OSCUDPTargetImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OSCUDPTargetImpl extends MinimalEObjectImpl.Container implements OSCUDPTarget
{
  /**
  ...
  {
    return OscDslPackage.Literals.OSCUDP_TARGET;
  }
  ...
  public void setProto(String newProto)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCUDP_TARGET__PROTO, oldProto, proto));
  }
  ...
  public void setAddr(String newAddr)
  {
    ...
    addr = newAddr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCUDP_TARGET__ADDR, oldAddr, addr));
  }
  ...
  public void setFormat(EzFormats newFormat)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OscDslPackage.OSCUDP_TARGET__FORMAT, oldFormat, format));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OscDslPackage.OSCUDP_TARGET__PROTO:
        return getProto();
      case OscDslPackage.OSCUDP_TARGET__ADDR:
        return getAddr();
      case OscDslPackage.OSCUDP_TARGET__FORMAT:
        return getFormat();
    }
