 ...
 * <ul>
 *   <li>{@link net.sf.smbt.osc.oscDsl.JvmVar#getName <em>Name</em>}</li>
 *   <li>{@link net.sf.smbt.osc.oscDsl.JvmVar#getJavaTypes <em>Java Types</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.smbt.osc.oscDsl.OscDslPackage#getJvmVar()
 * @model
 * @generated
 */
public interface JvmVar extends EObject
{
   ...
   * @see #setName(String)
   * @see net.sf.smbt.osc.oscDsl.OscDslPackage#getJvmVar_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link net.sf.smbt.osc.oscDsl.JvmVar#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see net.sf.smbt.osc.oscDsl.OscDslPackage#getJvmVar_JavaTypes()
   * @model
   * @generated
   */
