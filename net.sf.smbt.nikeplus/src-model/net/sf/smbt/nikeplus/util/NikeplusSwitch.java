 ...
 * @generated
 */
public class NikeplusSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NikeplusPackage.NIKEPLUS_CMD: {
				NikeplusCmd nikeplusCmd = (NikeplusCmd)theEObject;
				T result = caseNikeplusCmd(nikeplusCmd);
				if (result == null) result = caseHttpCommCmd(nikeplusCmd);
				if (result == null) result = caseCmd(nikeplusCmd);
	 ...
	 * @generated
	 */
	public T caseNikeplusCmd(NikeplusCmd object) {
		return null;
	}
