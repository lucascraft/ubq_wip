/**
 */
package net.sf.smbt.nikeplus.util;
 ...
 * @generated
 */
public class NikeplusAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static NikeplusPackage modelPackage;
	 ...
	 * @generated
	 */
	public NikeplusAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = NikeplusPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected NikeplusSwitch<Adapter> modelSwitch =
		new NikeplusSwitch<Adapter>() {
			@Override
			public Adapter caseNikeplusCmd(NikeplusCmd object) {
				return createNikeplusCmdAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.nikeplus.NikeplusCmd <em>Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNikeplusCmdAdapter() {
		return null;
	}
