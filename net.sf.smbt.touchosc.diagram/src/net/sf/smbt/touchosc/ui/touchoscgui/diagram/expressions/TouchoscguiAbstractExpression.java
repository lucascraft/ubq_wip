 ...
 * @generated
 */
public abstract class TouchoscguiAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = TouchoscguiDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected TouchoscguiAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
