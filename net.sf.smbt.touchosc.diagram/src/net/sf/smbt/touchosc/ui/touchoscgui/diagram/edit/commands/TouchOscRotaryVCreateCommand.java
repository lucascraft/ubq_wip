 ...
 * @generated
 */
public class TouchOscRotaryVCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscRotaryVCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscRotaryV newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscRotaryV();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getRotariesV().add(newElement);

		ElementInitializers.getInstance().init_TouchOscRotaryV_3009(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscRotaryV newElement,
