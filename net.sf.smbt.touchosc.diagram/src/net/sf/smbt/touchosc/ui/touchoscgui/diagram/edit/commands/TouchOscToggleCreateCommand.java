 ...
 * @generated
 */
public class TouchOscToggleCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscToggleCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscToggle newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscToggle();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getToggles().add(newElement);

		ElementInitializers.getInstance().init_TouchOscToggle_3011(newElement);
		newElement.setName("toggle" + TouchOscGuiUtilities.INSTANCE.getCounter("toggle"));
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscToggle newElement,
