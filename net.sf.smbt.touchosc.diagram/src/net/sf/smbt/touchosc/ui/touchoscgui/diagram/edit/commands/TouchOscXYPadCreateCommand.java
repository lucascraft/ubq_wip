 ...
 * @generated
 */
public class TouchOscXYPadCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscXYPadCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscXYPad newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscXYPad();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getXyPads().add(newElement);

		ElementInitializers.getInstance().init_TouchOscXYPad_3010(newElement);
		newElement.setName("xypad" + TouchOscGuiUtilities.INSTANCE.getCounter("xypad"));
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscXYPad newElement,
