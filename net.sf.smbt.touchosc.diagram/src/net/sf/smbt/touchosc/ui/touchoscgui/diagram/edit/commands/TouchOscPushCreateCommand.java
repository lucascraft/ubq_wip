 ...
 * @generated
 */
public class TouchOscPushCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscPushCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscPush newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscPush();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getPushes().add(newElement);

		ElementInitializers.getInstance().init_TouchOscPush_3007(newElement);
		newElement.setName("push" + TouchOscGuiUtilities.INSTANCE.getCounter("push"));
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscPush newElement,
