 ...
 * @generated
 */
public class TouchOscTimeHCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscTimeHCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscTimeH newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscTimeH();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getTimesH().add(newElement);

		ElementInitializers.getInstance().init_TouchOscTimeH_3012(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscTimeH newElement,
