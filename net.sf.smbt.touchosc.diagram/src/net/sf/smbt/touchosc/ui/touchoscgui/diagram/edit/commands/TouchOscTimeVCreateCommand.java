 ...
 * @generated
 */
public class TouchOscTimeVCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscTimeVCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscTimeV newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscTimeV();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getTimesV().add(newElement);

		ElementInitializers.getInstance().init_TouchOscTimeV_3013(newElement);
		newElement.setName("time" + TouchOscGuiUtilities.INSTANCE.getCounter("time"));
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscTimeV newElement,
