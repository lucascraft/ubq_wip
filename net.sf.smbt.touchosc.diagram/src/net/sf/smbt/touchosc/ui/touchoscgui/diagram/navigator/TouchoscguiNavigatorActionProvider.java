 ...
 * @generated
 */
public class TouchoscguiNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TouchoscguiNavigatorItem) {
					selectedElement = ((TouchoscguiNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (TouchOscLayoutEditPart.MODEL_ID
							.equals(TouchoscguiVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, TouchoscguiDiagramEditor.ID);
