 ...
 * @generated
 */
public class TouchOscBatteryHCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public TouchOscBatteryHCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TouchOscBatteryH newElement = TouchoscguiFactory.eINSTANCE
				.createTouchOscBatteryH();

		TouchOscTabPage owner = (TouchOscTabPage) getElementToEdit();
		owner.getBatteriesH().add(newElement);

		ElementInitializers.getInstance()
				.init_TouchOscBatteryH_3015(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(TouchOscBatteryH newElement,
