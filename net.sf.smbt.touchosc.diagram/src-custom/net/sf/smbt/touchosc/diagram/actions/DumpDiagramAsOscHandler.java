...
public class DumpDiagramAsOscHandler extends AbstractHandler {
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Object elem = ((TouchoscguiDiagramEditor) diagramEditor).getDiagram().getElement();
		if (elem instanceof TouchOscLayout) {
			List<OscCmd> lst = TouchOscGuiUtilities.INSTANCE.dumpGuiAsOsc((TouchOscLayout) elem);
