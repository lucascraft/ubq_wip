...
public class TouchOscControlLocalFeedbackOffFilter implements IFilter {

	public boolean select(Object toTest) {
		return 
		toTest instanceof TouchOscPushEditPart || 
		toTest instanceof TouchOscMultiPushEditPart ||
		toTest instanceof TouchOscToggleEditPart || 
		toTest instanceof TouchOscMultiToggleEditPart;
	}
}
