...
public class TouchOscControlToSection extends AbstractIntegerPropertySection {


	@Override
	protected EStructuralFeature getFeature() {
		return TouchoscguiPackage.Literals.TOUCH_OSC_CONTROL__SCALET;
	}
	...
	protected Integer getFeatureInteger() {
		return getEObject() instanceof TouchOscControl ? 
				new Integer(((TouchOscControl)getEObject()).getScalet())
					: new Integer(0);
	}
