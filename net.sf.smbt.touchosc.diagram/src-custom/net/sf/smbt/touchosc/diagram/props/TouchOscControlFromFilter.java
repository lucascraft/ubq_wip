...
public class TouchOscControlFromFilter implements IFilter {

	public boolean select(Object toTest) {
		return !(
			toTest instanceof TouchOscTimeHEditPart || 
			toTest instanceof TouchOscTimeVEditPart || 
			toTest instanceof TouchOscBatteryHEditPart || 
			toTest instanceof TouchOscBatteryVEditPart || 
			toTest instanceof TouchOscLabelHEditPart|| 
			toTest instanceof TouchOscLabelVEditPart||
			toTest instanceof TouchOscTabPageEditPart);
	}
}
