...
public class TouchOscControlCenteredFilter implements IFilter {

	public boolean select(Object toTest) {
		return 
			toTest instanceof TouchOscRotaryHEditPart || 
			toTest instanceof TouchOscRotaryVEditPart || 
			toTest instanceof TouchOscFaderHEditPart || 
			toTest instanceof TouchOscFaderVEditPart || 
			toTest instanceof TouchOscMultiFaderHEditPart|| 
			toTest instanceof TouchOscMultiFaderVEditPart;
	}
}
