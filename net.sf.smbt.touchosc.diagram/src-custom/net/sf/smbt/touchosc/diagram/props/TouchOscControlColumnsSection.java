...
public class TouchOscControlColumnsSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return TouchoscguiPackage.Literals.TOUCH_OSC_CONTROL__NUMBER_X;
	}
	...
	protected Integer getFeatureInteger() {
		return getEObject() instanceof TouchOscControl ? 
				new Integer(((TouchOscControl)getEObject()).getNumber_x())
					: new Integer(0);
	}
