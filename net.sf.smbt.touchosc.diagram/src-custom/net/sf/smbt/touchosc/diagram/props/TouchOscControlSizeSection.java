...
public class TouchOscControlSizeSection extends AbstractIntegerPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return TouchoscguiPackage.Literals.TOUCH_OSC_CONTROL__SIZE;
	}
	...
	protected Integer getFeatureInteger() {
		return getEObject() instanceof TouchOscControl ? 
				new Integer(((TouchOscControl)getEObject()).getSize())
					: new Integer(0);
	}
