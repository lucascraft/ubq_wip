...
public class JZUIMultiBallsPhysicsSection extends AbstractEnumerationPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__PHYSICS;
	}
	...
	private static String[] choices =  new String[] { 
		MULTIBALLS_PHYSICS.NONE.getLiteral(), 
		MULTIBALLS_PHYSICS.INTERPOLATE.getLiteral(),
		MULTIBALLS_PHYSICS.MASS_SPRING.getLiteral()
	};
	...
	protected Object getOldFeatureValue() {
		return getEObject() instanceof JZMultiBalls ? 
				((JZMultiBalls)getEObject()).getPhysics()
					: "";
	}
}
