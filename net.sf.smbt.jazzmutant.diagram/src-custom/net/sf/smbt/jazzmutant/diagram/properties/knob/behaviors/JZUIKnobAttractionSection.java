...
public class JZUIKnobAttractionSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_KNOB__ATTRACTION;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZKnob)getEObject()).getAttraction());
	}
}
