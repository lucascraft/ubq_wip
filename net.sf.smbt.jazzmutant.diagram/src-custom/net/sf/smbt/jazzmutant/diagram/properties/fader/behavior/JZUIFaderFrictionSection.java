...
public class JZUIFaderFrictionSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_FADER__FRICTION;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZFader)getEObject()).getFriction());
	}
}
