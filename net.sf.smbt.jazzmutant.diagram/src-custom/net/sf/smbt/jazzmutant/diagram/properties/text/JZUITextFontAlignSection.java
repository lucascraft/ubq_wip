...
public class JZUITextFontAlignSection extends AbstractEnumerationPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_TEXT__FONT_ALIGN;
	}
	...
	protected Object getOldFeatureValue() {
		return getEObject() instanceof JZText ? 
				((JZText)getEObject()).getFontAlign()
					: "";
	}
