...
public class JZUIMultiBallsFrictionSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__FRICTION;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZMultiBalls)getEObject()).getFriction());
	}
}
