...
public class JZUIMultiBallsHoldXSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__HOLD_X;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZMultiBalls)getEObject()).getHoldX());
	}
}
