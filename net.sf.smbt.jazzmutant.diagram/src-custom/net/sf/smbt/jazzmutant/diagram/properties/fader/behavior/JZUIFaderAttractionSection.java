...
public class JZUIFaderAttractionSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_FADER__ATTRACTION;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZFader)getEObject()).getAttraction());
	}
}
