...
public class JZUICustomButtonLightSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_CUSTOM_BUTTON__LIGHT;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZCustomButton)getEObject()).getLight());
	}
}
