...
public class JZUIMultiBallsHoldYSection extends AbstractFloatPropertySection {

	@Override
	protected EStructuralFeature getFeature() {
		return JzmuiPackage.Literals.JZ_MULTI_BALLS__HOLD_Y;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((JZMultiBalls)getEObject()).getHoldY());
	}
}
