...
public class JZSwitchesFigure extends AbstractTextualLemurFigure {
	protected JZSwitches switches;
	public JZSwitchesFigure(JZSwitches elem) {
		super(elem);
		switches = elem;
	}
    @Override
    public void paint(Graphics graphics) {
    	...
    	if (!graphics.getAdvanced()) {
	   	...
	   	Color color = switches.getColorOff();
