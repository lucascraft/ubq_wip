 ...
 * @generated
 */
public class JzmuiDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public JzmuiDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof JzmuiDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((JzmuiDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new JzmuiDomainNavigatorItem((EObject) objects[i],
