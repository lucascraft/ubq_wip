...
import net.sf.smbt.jzmui.diagram.edit.parts.JzmuiEditPartFactory;
 ...
 * @generated
 */
public class JzmuiEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public JzmuiEditPartProvider() {
		setFactory(new JzmuiEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!JZJazzInterfaceEditPart.MODEL_ID.equals(JzmuiVisualIDRegistry
					.getModelID(view))) {
				return false;
			}
