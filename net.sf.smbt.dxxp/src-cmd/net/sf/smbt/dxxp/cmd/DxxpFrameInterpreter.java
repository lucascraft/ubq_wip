...
import net.sf.smbt.dxxp.osc.DxxpOscCmdUtils;
import net.sf.xqz.model.cmd.Cmd;
import net.sf.xqz.model.engine.impl.AbstractFrameInterpreterImpl;

import org.eclipse.core.runtime.Platform;

public class DxxpFrameInterpreter extends AbstractFrameInterpreterImpl {
	...
	public synchronized Cmd byteArray2Cmd(final byte[] frame) {
		...
		return DxxpOscCmdUtils.INSTANCE.handleDxxPFrame(frame);
	}
}
