...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.wiimotectrl.WiimoteController} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WiimoteControllerItemProvider
	 ...
	 * @generated
	 */
	public WiimoteControllerItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addWiiidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WiimoteController_wiiid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WiimoteController_wiiid_feature", "_UI_WiimoteController_type"),
				 WiimotectrlPackage.Literals.WIIMOTE_CONTROLLER__WIIID,
				 true,
				 false,
				 false,
	...
	protected void addAddrPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WiimoteController_addr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WiimoteController_addr_feature", "_UI_WiimoteController_type"),
				 WiimotectrlPackage.Literals.WIIMOTE_CONTROLLER__ADDR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WiimotectrlPackage.Literals.WIIMOTE_CONTROLLER__PROPERTIES);
		}
	...
	/**
	 * This returns WiimoteController.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WiimoteController"));
	}
	...
	public String getText(Object object) {
		String label = ((WiimoteController)object).getWiiid();
		return label == null || label.length() == 0 ?
			getString("_UI_WiimoteController_type") :
			getString("_UI_WiimoteController_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WiimoteController.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WiimotectrlPackage.Literals.WIIMOTE_CONTROLLER__PROPERTIES,
				 WiimoteFactory.eINSTANCE.createWiimoteLiveSettings()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return WiimotectrlEditPlugin.INSTANCE;
	}
