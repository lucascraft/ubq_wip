...
public abstract class AbstractGroovixOutlinePage extends Page implements IContentOutlinePage, ISelectionChangedListener, IAdaptable {
	...
	private AbstractGroovixModelNavigator navigator;
...
//	private CollapseAllHandler collapseAllHandler;
	 ...
	 */
	public AbstractGroovixOutlinePage(GroovixEditor ed) {
...
*/
	 ...
	 * @return the editor
	 */
	protected GroovixEditor getEditor() {
		return editor;
	}
	 ...
	 */
	protected abstract AbstractGroovixModelNavigator createNavigator(Composite parent, IPageSite pageSite);
