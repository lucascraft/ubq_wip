...
public abstract class AbstractGroovixModelNavigator extends Composite implements IMenuListener {
	 ...
	 *            the site
	 */
	public AbstractGroovixModelNavigator(Composite parent, GroovixEditor diagEditor, IPageSite pageSite) {
