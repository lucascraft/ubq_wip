...
import net.sf.smbt.ui.touchosc.controller.figures.LabelVFigure;
...
public class LabelVEditPart extends AbstractGraphicalEditPart {
	...
	protected IFigure createFigure() {
	    ...
	    return new LabelVFigure((LabelV) getModel());
	}
	
	@Override
	public void activate() {
		synchronized (getModel()) {
		    synchronized (((LabelV)getModel()).eAdapters()) {
		    	((LabelV)getModel()).eAdapters().add(uiAdapter);
		    }
		}
		super.activate();
	}
	...
	public void deactivate() {
		super.deactivate();
		synchronized (getModel()) {
			if (getModel() instanceof LabelV) {
			   synchronized (((LabelV)getModel()).eAdapters()) {
				    if (getModel() != null && ((LabelV)getModel()).eAdapters().contains(uiAdapter)) {
				    	((LabelV)getModel()).eAdapters().remove(uiAdapter);
				    }
			    }
			} 
		}
	...
	protected void refreshVisuals() {
		LabelV jzFader = (LabelV) getModel();
