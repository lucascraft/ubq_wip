...
public class LEDFigure extends AbstractLemurFigure {
	@SuppressWarnings("unused")
	private LED led;
	private int r, c;
	
	public LEDFigure(LED elem) {
		super(elem);
		led = elem;
	   	r = elem.getRows();
    	c = elem.getColumns();
    	...
    	for (int _r = 0; _r<r; _r++) {
        	for (int _c = 0; _c<c; _c++) {
        		add(new TLEDFigure(n, _r, _c));
        	}	
    	}
	}
	public class TLEDFigure extends Figure {
	   	public int nbr, row, col;
    	public TLEDFigure(int n, int r, int c) {
    		nbr = n;
    		row = r;
    		col = c;
