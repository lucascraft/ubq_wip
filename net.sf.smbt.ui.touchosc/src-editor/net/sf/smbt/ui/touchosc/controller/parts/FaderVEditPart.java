...
import net.sf.smbt.ui.touchosc.controller.figures.FaderVFigure;
...
public class FaderVEditPart extends AbstractGraphicalEditPart {
	...
	protected IFigure createFigure() {
	    ...
	    return new FaderVFigure((FaderH) getModel());
	}
	...
	protected void refreshVisuals() {
		...
		if (getFigure().getChildren().size()>0) {
			FaderVFigure.LemufaderCursorFigure cursorFigure = (FaderVFigure.LemufaderCursorFigure) getFigure().getChildren().get(0);
